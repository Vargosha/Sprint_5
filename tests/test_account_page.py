from locators import HomePageLocators, AccountPageLocators
from selenium.webdriver.support import expected_conditions
from selenium.webdriver.support.wait import WebDriverWait
from config import URLS

class TestUserAccountPage:
    def test_account_page_opens_after_successful_login(self,browser,authorized_user):
    ...
    def test_user_can_logout_via_logout_button_from_account_page(self,browser,authorized_user):
        ...
        assert browser.current_url == URLS["login"]
