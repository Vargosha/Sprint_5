...
def test_registration_creates_new_user(browser,random_user):
...
def test_registration_with_password_less_than_6_characters_shows_error(browser,random_user):
...
def test_registration_with_empty_password_does_not_creates_new_user(browser,random_user):
