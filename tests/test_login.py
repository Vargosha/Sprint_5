...
class TestUserLogin:
    def test_user_can_login_via_login_button_on_home_page(self,browser):
    ...
    def test_user_can_login_via_profile_button(self,browser):
    ...
    def test_user_can_login_via_login_button_on_registration_page(self,browser):
    ...
    def test_user_can_login_via_login_button_on_forgot_password_page(self,browser):
